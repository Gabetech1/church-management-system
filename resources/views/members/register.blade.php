        ...
        <div id="page-content">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="panel rounded-top" style="background-color: #c0e0ff;">
                        ...
                        <div class="row panel-body" style="background-color: #c0e0ff;">
                                ...
                                <form id="register-form" method="POST" action="{{ route('member.register') }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-readonly-input">Membership
                                                No.</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Other
                                                Name(s)</label>
                                            <div class="col-md-9">
                                                <input type="text" id="demo-text-input" name="othername"
                                                    class="form-control" placeholder="Lastname" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Day Born</label>
                                            <div class="col-md-9">
                                                <input type="text" id="demo-text-input" name="othername"
                                                    class="form-control" placeholder="Day Born" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php } ?>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-textarea-input">Home Town</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="hometown"
                                                    placeholder="Enter member hometown" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-textarea-input">Current Location</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="current_location"
                                                    placeholder="Enter member Current Location" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group pad-ver">
                                            ...
                                            <div class="col-md-9">
                                                <div class="radio">
                                                    ...
                                                    <input id="demo-inline-form-radio-3" class="magic-radio"
                                                        value="divorced" type="radio" name="marital_status">
                                                    <label for="demo-inline-form-radio-3">Divorced</label>
                                                </div>

                                            </div>
                                        </div>
                                        <div class="form-group pad-ver">
                                            <label class="col-md-3 control-label">If Married</label>
                                            <div class="col-md-9">
                                                <div class="radio">

                                                    <input id="demo-inline-form-radio1" class="magic-radio"
                                                        value="ordinance" type="radio" name="marital_type">
                                                    <label for="demo-inline-form-radio1">Ordinance</label>

                                                    <input id="demo-inline-form-radio2" class="magic-radio"
                                                        value="customary" type="radio" name="marital_type">
                                                    <label for="demo-inline-form-radio2">Customary</label>
                                                </div>
                                            </div>
                                        </div>

                                        {{-- <div id="wedding" class="form-group" style="display:none">
									<label class="col-md-3 control-label" for="demo-text-input">If Married</label>
									<div class="col-md-9">
									<input id="anniversary"  type="text" placeholder="Date Married" name="wedding_anniversary" class="datepicker form-control"/>

									</div>
								</div> --}}
                                        <div id="wedding" class="form-group" style="display:none">
                                            <div class="col-md-3 control-label">
                                                <label class="" for="demo-text-input">Date Married</label>
                                            </div>

                                            <div class="col-md-9">
                                                <input id="anniversary" type="text" placeholder="Date Married"
