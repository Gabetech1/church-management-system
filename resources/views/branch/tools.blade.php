            ...
            <div class="panel" style="background-color: #e8ddd3;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="pad-all">
                            <table id="c-type-table" class="table table-striped table-bordered" cellspacing="0"
                                width="100%">
                                <thead>
                                </thead>
                                <tbody>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pad-all">
                            <table id="s-type-table" class="table table-striped table-bordered" cellspacing="0"
                                width="100%">
                                <thead>
                                </thead>
                                <tbody>
          ...
          //  $.fn.dataTable.ext.errMode = () => alert('Error while loading the table data. Please refresh');
            $('#collection_type_form').submit((e) => {
                ...
                poster({
                    ...
                    resetForm('#collection_type_form')
                })
            })
            //
